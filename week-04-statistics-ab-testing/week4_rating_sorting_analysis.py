...
###################################################
df = pd.read_csv("databases/amazon_review.csv")
df.head()
df.shape
df["asin"].nunique()
df["overall"].mean()
...
###################################################
df[["helpful" , "helpful_yes"]].head(20)
df["helpful"].unique()
df["helpful_yes"].unique()
df.info()
#df["helpful_no"] = df["helpful"].str[4]
df["helpful_no"] = df["total_vote"] - df["helpful_yes"]
df["helpful_no"].unique()
df[["helpful" , "helpful_yes", "helpful_no"]].tail(40)
